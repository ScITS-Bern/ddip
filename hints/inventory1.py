...
class Container:
    ...
    def remove(self, item):
        ...
        # The item counts are stored in a dict "self._counts"
        # Check if the count for the item is greater than zero, and if it is - decrease by one
        # Code should raise an error if the item's count is not found or zero
